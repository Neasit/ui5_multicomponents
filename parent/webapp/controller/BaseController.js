sap.ui.define(['sap/ui/core/mvc/Controller', 'sap/m/MessageToast', 'app/parent/model/formatter'], function(Controller, MessageToast, formatter) {
  'use strict';

  return Controller.extend('app.parent.controller.BaseController', {
    formatter: formatter,
